...
function CartConfirm({ setStep, setLoading, setTotal, delivery, setDelivery }) {
  ...
  const nextStep = () => {
    if (!click.personalInfoAgree) {
      return toast.error("請簽屬同意商店服務條款");
    } else if (!click.vetoAgree) {
      return toast.error("請簽屬確認賣家可否決權利");
    }
    setStep("fill");
    window.scrollTo({
      top: 0,
  ...
  return (
    <>
      <div className="col col-lg-8 d-flex flex-column gap-26">
        <div className="buyer">
          <div className="fs-2 text-primary-700 fw-bold mb-15">購物車內容</div>
          ...
          <div className="row">
            ...
            <div className="col-6 pt-8 pt-md-10">
              <label htmlFor="discount" className="text-gary-500 fs-6 fs-md-5">
                優惠折扣碼
              </label>
          ...
          <div className="cart-info-bgcolor p-10 mt-lg-10">
            ...
            <ol className="mb-0 ps-6">
              <li className="text-gary-500 cart-info-li-text">
                除商品缺貨外，訂單付款完成後 5~7 個工作天（不含例假日）進行出貨
              </li>
              <li className="text-gary-500 cart-info-li-text">
